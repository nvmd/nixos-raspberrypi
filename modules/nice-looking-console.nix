...
let
  cfg = config.hardware.raspberry-pi.nice-looking-console;
in
{
  options.hardware.raspberry-pi.nice-looking-console = {
    enable = lib.mkEnableOption "nice-looking console (Terminus font, Tango colors)" // {
      default = true;
    };
  };
